...
<head>
    ...
    <title> Elbuencubito - Register </title>
</head>
<body>
    <header>
        <nav class="nav">
    ...
    <div class="login__fondo">
       ...
       <div class="login__div">
            <form method="post">
                <h1 class="bb__title">Registrarse</h1>
                <input class="bb__input name" name="name" type="text" placeholder="Nombre de usuario">
                <input class="bb__input contra" name="contraseña" type="password" placeholder="Contraseña">
                <input class="bb__input contra1" name="contraseña1" type="password" placeholder="Confirmar contraseña">
                <p style="font-size: 14px; grid-row: 5/ 6;">¿Ya tienes una cuenta? <a href="login.php">Loguéate</a></p>
                <input class="bb__button" name="register" type="submit" value="Enviar">
            </form>
            <?php
